...
_lr_productions = [
  ...
  ('program -> statements','program',1,'p_program','cql_grammar.py',89),
  ('statements -> statements statement','statements',2,'p_statements','cql_grammar.py',93),
  ('statements -> statement','statements',1,'p_statements','cql_grammar.py',94),
  ('statement -> IMPORT TABLE IDENTIFIER FROM STRING SEMICOLON','statement',6,'p_statement_import','cql_grammar.py',102),
  ('statement -> EXPORT TABLE IDENTIFIER AS STRING SEMICOLON','statement',6,'p_statement_export','cql_grammar.py',106),
  ('statement -> DISCARD TABLE IDENTIFIER SEMICOLON','statement',4,'p_statement_discard','cql_grammar.py',110),
  ('statement -> RENAME TABLE IDENTIFIER IDENTIFIER SEMICOLON','statement',5,'p_statement_rename','cql_grammar.py',114),
  ('statement -> PRINT TABLE IDENTIFIER SEMICOLON','statement',4,'p_statement_print','cql_grammar.py',118),
  ('statement -> SELECT select_columns FROM IDENTIFIER where_clause limit_clause SEMICOLON','statement',7,'p_statement_select','cql_grammar.py',122),
  ('select_columns -> ASTERISK','select_columns',1,'p_select_columns_asterisk','cql_grammar.py',126),
  ('select_columns -> column_list','select_columns',1,'p_select_columns_list','cql_grammar.py',130),
  ('column_list -> IDENTIFIER','column_list',1,'p_column_list','cql_grammar.py',134),
  ('column_list -> column_list COMMA IDENTIFIER','column_list',3,'p_column_list','cql_grammar.py',135),
  ('where_clause -> WHERE condition','where_clause',2,'p_where_clause','cql_grammar.py',143),
  ('where_clause -> empty','where_clause',1,'p_where_clause','cql_grammar.py',144),
  ('condition -> IDENTIFIER EQUALS value','condition',3,'p_condition','cql_grammar.py',148),
  ('condition -> IDENTIFIER NOTEQUAL value','condition',3,'p_condition','cql_grammar.py',149),
  ('condition -> IDENTIFIER GT value','condition',3,'p_condition','cql_grammar.py',150),
  ('condition -> IDENTIFIER LT value','condition',3,'p_condition','cql_grammar.py',151),
  ('condition -> IDENTIFIER GE value','condition',3,'p_condition','cql_grammar.py',152),
  ('condition -> IDENTIFIER LE value','condition',3,'p_condition','cql_grammar.py',153),
  ('condition -> condition AND condition','condition',3,'p_condition','cql_grammar.py',154),
  ('limit_clause -> LIMIT NUMBER','limit_clause',2,'p_limit_clause','cql_grammar.py',161),
  ('limit_clause -> empty','limit_clause',1,'p_limit_clause','cql_grammar.py',162),
  ('value -> NUMBER','value',1,'p_value','cql_grammar.py',166),
  ('value -> STRING','value',1,'p_value','cql_grammar.py',167),
  ('statement -> CREATE TABLE IDENTIFIER select_source SEMICOLON','statement',5,'p_statement_create','cql_grammar.py',172),
  ('statement -> CREATE TABLE IDENTIFIER SELECT select_columns FROM IDENTIFIER where_clause limit_clause SEMICOLON','statement',10,'p_statement_create','cql_grammar.py',173),
  ('select_source -> FROM IDENTIFIER','select_source',2,'p_select_source','cql_grammar.py',187),
  ('select_source -> FROM IDENTIFIER JOIN IDENTIFIER USING LPAREN IDENTIFIER RPAREN','select_source',8,'p_select_source','cql_grammar.py',188),
  ('statement -> PROCEDURE IDENTIFIER DO statements END','statement',5,'p_statement_procedure','cql_grammar.py',195),
  ('statement -> PROCEDURE IDENTIFIER DO statements END SEMICOLON','statement',6,'p_statement_procedure','cql_grammar.py',196),
  ('statement -> CALL IDENTIFIER SEMICOLON','statement',3,'p_statement_call','cql_grammar.py',200),
  ('empty -> <empty>','empty',0,'p_empty','cql_grammar.py',204),
]
